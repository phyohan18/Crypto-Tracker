...
export default function BalanceInfoCard({provider , accountAddress}) {
    ...
    const fetchBalances = async () =>{
        ...
        const [nativeBalance,currencySymbol] = await getBalanceStats(provider,accountAddress)
        //account change yin run
        const coinInfo = await getCoinChangePrice(defaultCurrency,currencySymbol)// defaultCurrency change yin run
        //coinInfo, nativeBalance, currencySymbol
