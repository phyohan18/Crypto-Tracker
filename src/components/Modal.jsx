        ...
        <>
            ...
            <label for="my-modal-4" className="modal modal-bottom sm:modal-middle cursor-pointer duration-300 ">
                <label className="modal-box relative bg-gray-100 dark:bg-gray-900">
                    ...
                    { accountAddress ?
                        <div className="flex gap-4 rounded-xl mt-5 p-2 items-center">
                            ...
                            <img src="https://cdn-icons-png.flaticon.com/512/463/463574.png" width="21" height="21" alt="" title=""/> 
                        </div>
                        :
                    ...
                    { accountAddress && 
                        <div className="flex justify-end">
                            <Link to="dashboard" className="btn border-transparent hover:border-transparent bg-teal-500 font-semibold text-accent-content uppercase hover:bg-teal-600 duration-200">Visit Dashbord</Link>
                        </div>
                    }                 
                </label>
            </label>
