                    ...
                    <ul className="list-reset flex justify-end flex-1 items-center">
                        ...
                        <li className="ml-1">
                            <div title="Change Currency" className="dropdown dropdown-end">
                                ...
                                <div className="dropdown-content bg-base-100 text-base-content rounded-t-box rounded-b-box top-px h-auto w-52 overflow-y-auto shadow-2xl mt-16">
                                    <ul className="menu menu-compact p-4 gap-y-1.5">
                                        <li><button className={i18next.language == 'en' ? 'active text-white' : ''} onClick={()=>changeLang('en')}> <span class="flex flex-1 justify-between">English </span></button></li>
                                        <li><button className={i18next.language == 'mm' ? 'active text-white' : ''}onClick={()=>changeLang('mm')}> <span class="flex flex-1 justify-between">MM </span></button></li>                            
                                    </ul>
                                </div>
                            </div>
                        </li>
